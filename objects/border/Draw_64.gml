...
<<<<<<< HEAD
draw_spr(bo_simple,,-160,-30,0.5,,c_black,1)
=======
...
if cur_b != 0 and window_get_fullscreen() {
	...
	var bs = 1
	if spr_exists(spr[e]) and spr_h(spr[e]) = 1080 {bs = 0.5}
...
<<<<<<< HEAD
			draw_spr(bo_simple,fr[i],-160,-30,0.5,,merge_color(c_white,c_black,img[i] = -2),_a)
		}
		else {
			if img[i] = 0 and !e {
				draw_spr(fbo_0,img[i] - 1,-160,-30,0.5,,,_a)
				var fs = fspr - 1

				if fspr {
					draw_spr(fbo_1,fs,x + 867,y + 2,0.5)
					draw_spr(fbo_2,fs,x + 914.5,y + 182,0.5)
					draw_spr(fbo_3,fs,x + 47,y + 472,0.5)
					draw_spr(fbo_4,fs,x - 0.5,y + 162,0.5)
					draw_spr(fbo_5,fs,x + 894.5,y + 357,0.5)
					draw_spr(fbo_6,fs,x + 17,y + 342,0.5)
					draw_spr(fbo_8,fs,x + 104.5,y + 19.5,0.5)
					draw_spr(fbo_9,fs,x + 134.5,y + 247,0.5)
					draw_spr(fbo_10,fs,x + 792,y + 527,0.5)
				}
			}
			else {
				if spr_exists(spr[e]) {
					draw_spr(spr[e],img[i] - 1,-160,-30,bs,,,_a)
					//add your cool custom border properties here
				}
=======
...
<<<<<<< HEAD
	if in_debug() {
		draw_font(1)
		draw_txt_outline(4,-14,$"{img}, {_f}",c_white,,,,,1,1)
=======
